...
Implement the EM algorithm for a K-component univariate Gaussian mixture model.
...
Apply the EM function with K = 3 to the following data vector containing n = 10 observations.
...
Apply the EM function to data simulated as follows (i.e. two clearly separated groups).
